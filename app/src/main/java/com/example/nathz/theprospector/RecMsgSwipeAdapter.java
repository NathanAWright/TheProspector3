...
public class RecMsgSwipeAdapter extends FragmentStatePagerAdapter{
    ...
    public Fragment getItem(int position) {
        ...
        if (position+1 == 1) {
            ...
            bundle.putString("yesAnswer1", "Excellent, we look forward to seeing you. Please be reminded that you may bring with you: friends, family, or a financial advisor, if you wish. Enjoy the rest of your [day/night].");
            bundle.putString("yesAnswer2", "Excellent. Please be reminded that you may bring with you: friends, family, or a financial advisor, if you wish. We will follow up soon, do enjoy the rest of your [day/night]!");
            ...
            bundle.putString("convoStartText", "\n" +
                    ...
                    "\nOur friends have agreed that this upcoming [day/month] at [time AM/PM] will be best for you to meet with a few others who have been contacted like yourself, based on interest shown.\n" +
                    "\n" +
            ...
            bundle.putString("noAnswer1", "That will not be a problem [sir/ma'am]. Thank you for your time.\n" +
                    "We should soon have the same meeting hosted in an online room, for persons who are interested but are bedridden or simply too busy to grace us with their physical presence. We also have recordings that efficiently give you all of the relevant information in a small time frame for you to watch whenever you have time. (However they are not recommended as you will not be able to ask questions.)\n" +
                    "\n" +
                    "Would you like to have the link to the live meeting room (highly recommended over the recordings), or would you like the recordings link?");
            bundle.putString("convoStartText", "\n" +
                    ...
                    "Our friends (the experts) are willing to meet other individuals like yourself who have shown interest in the information, and will share all of the relevant information with them.\n" +
                    ...
                    "\n" +
                    "(Please understand that no commitments are required, it is entirely your decision to take this information and do with it what you will).\n\n" +
                    "The agreed date is this upcoming [day/month] at [time AM/PM], best suited for the other relevant persons for whom this meeting was intended.\n" +
                    "\n" +
            ...
            bundle.putString("recordingsFollowUpText", "Good [day/night] [sir/ ma'am] this is a follow up message to ensure that you have viewed the short recordings, please let us know if you have any feedback at your earliest convenience.\n" +
            ...
            bundle.putString("questionsResponse", "I understand your natural curiosity of the business' nature; here is the snippet of information that I am qualified to share, additional questions will have to be answered by experts when you have made contact with them. I apologise for any inconvenience caused.\n" +
                    "\nThe nature of the business revolves around the use of any smart device and the internet's resources to establish financial gains. Physical labour/presence at a work location is not required. If you do decide to get involved, you will be able to make financial gains from anywhere in the world as long as you have an active internet connection.");
        }
